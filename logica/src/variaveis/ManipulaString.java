...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Do 3° até o fim:" + email.substring(2,5));
		System.out.println("Do 3° até o fim:" + email.substring(2));
		...
		System.out.println("É igual?" + email.equals("Resilva.1986@Yahoo.com.br"));
