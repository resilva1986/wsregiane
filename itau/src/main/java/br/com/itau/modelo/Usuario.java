...
@Table(name="TB_USUARIO") // identifica qual é a tabela que estará associada a classe Usuario
public class Usuario {
	
	@Id // avisa ao Springboot que esta coluna é a chave primária da tabela
	@GeneratedValue(strategy = GenerationType.IDENTITY) // Identy=> representa o auto incremento do BD.
	@Column(name="id")
	private int id;
