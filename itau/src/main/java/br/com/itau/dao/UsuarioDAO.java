...
/* 
 * DAO => É UM PATTERN QUE SUGESTIONA ONDE DEVE FICAR OS COMANDOS SQL DML
 * Dentro das classes DAO's:
 * Deve montar o CRUD (create - Read - Update - Delete)
 */
public interface UsuarioDAO extends CrudRepository<Usuario, Integer>{
	/*
	 * CrudRepository é a classe pai do UsuarioDAO e está informando ao Spring que esta classe armazenará o CRUD para usuario. 
	 * O Integer é para especificar que o tipo de dado da chave primária é Integer.
	 	 ...
	 	 *- count(): retorna qunatos usuários existem
	 	 */
